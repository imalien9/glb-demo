...
function Model() {
  ...
  // 載入位於 public 資料夾的 BoxAnimated.glb
  const { scene } = useGLTF('/BoxAnimated.glb')
  const clonedScene = scene.clone()
  return (
    <group ref={group} position={[-1, 0, 0]} dispose={null}>
